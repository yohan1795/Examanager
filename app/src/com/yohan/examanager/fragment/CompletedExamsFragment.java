...
public class CompletedExamsFragment extends Fragment {
    ...
    public View onCreateView(LayoutInflater inflater, @Nullable ViewGroup container, @Nullable Bundle savedInstanceState) {
        ...
        adapter = new ExamListAdapter(getContext(),new ArrayList<ExamItem>(), COMPLETED_EXAMS);
    ...
    private void callApi(){
        ...
        Call<String> completedExamsCall= apiInterface.getCall("Bearer "+token, "completedexams", userId);
        completedExamsCall.enqueue(new Callback<String>() {
            @Override
