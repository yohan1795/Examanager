...
public class UpcomingExamsFragment extends Fragment {
    ...
    public View onCreateView(LayoutInflater inflater, @Nullable ViewGroup container, @Nullable Bundle savedInstanceState) {
        ...
        adapter = new ExamListAdapter(getContext(),new ArrayList<ExamItem>(), UPCOMING_EXAMS);
    ...
    private void callApi(){
        ...
        Call<String> upcomingExamsCall= apiInterface.getCall("Bearer "+token, "upcomingexams", userId);
        upcomingExamsCall.enqueue(new Callback<String>() {
            @Override
