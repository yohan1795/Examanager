...
public class UpcomingExamsFragment_ViewBinding<T extends UpcomingExamsFragment> implements Unbinder {
  protected T target;

  @UiThread
  public UpcomingExamsFragment_ViewBinding(T target, View source) {
    this.target = target;
